...
def load_model(model_path):
    ...
    # net.tokenizer = AutoTokenizer.from_pretrained("tunvx/bert-tiny-web-attack-classification")
    # net.tokenizer.model_max_length = 512
    # net.model = AutoModelForSequenceClassification.from_pretrained("tunvx/bert-tiny-web-attack-classification", torch_dtype="auto")
    net.eval()
    return net
